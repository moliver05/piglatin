...
#### Change words that have vowels and consonants and change them to following rules

#### Ahmed, Mark, Julius, Derek

## Description

A website created with JavaScript, CSS and HTML where a user can submit a word and determine its raw Scrabble score.
...
Copyright (c) 2017 **Ahmed, Mark, Julius, Derek**
